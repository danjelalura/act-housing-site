...
return cljs.core.map.call(null,(function (p1__18285_SHARP_){
return html_coll.item(p1__18285_SHARP_);
...
return cljs.core.some.call(null,(function (p1__18286_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__18286_SHARP_);
...
var ctx_18287 = cvs.getContext("2d");
(ctx_18287.fillStyle = color);

ctx_18287.fillRect((0),(0),size,size);
