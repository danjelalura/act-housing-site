...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_18310);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq18311){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18312,G__18313,seq18311__$2);
}));
...
var vec__18317 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__18317,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__18317,(1),null);
var G__18320 = cljs.core.PersistentArrayMap.EMPTY;
var G__18320__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__18320,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18320);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__18320__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__18320__$1;
}
} else {
...
return (function() { 
var G__18324__delegate = function (klass,contents){
var vec__18321 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__18321,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__18321,(1),null);
...
var G__18324 = function (klass,var_args){
var contents = null;
...
while (G__18325__i < G__18325__a.length) {G__18325__a[G__18325__i] = arguments[G__18325__i + 1]; ++G__18325__i;}
  contents = new cljs.core.IndexedSeq(G__18325__a,0,null);
} 
return G__18324__delegate.call(this,klass,contents);};
G__18324.cljs$lang$maxFixedArity = 1;
G__18324.cljs$lang$applyTo = (function (arglist__18326){
var klass = cljs.core.first(arglist__18326);
var contents = cljs.core.rest(arglist__18326);
return G__18324__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__18330){
...
var ns = cljs.core.get.call(null,map__18331__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__18331__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__18333){
var map__18334 = p__18333;
var map__18334__$1 = (((((!((map__18334 == null))))?(((((map__18334.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18334.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18334):map__18334);
var actual = cljs.core.get.call(null,map__18334__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__18334__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__18336){
var map__18337 = p__18336;
var map__18337__$1 = (((((!((map__18337 == null))))?(((((map__18337.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18337.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18337):map__18337);
var expected = cljs.core.get.call(null,map__18337__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__18337__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__18339_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__18339_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__18341 = cljs_test_display.core.current_var_info.call(null);
var map__18341__$1 = (((((!((map__18341 == null))))?(((((map__18341.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18341.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18341):map__18341);
var info = map__18341__$1;
var name = cljs.core.get.call(null,map__18341__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__18341__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__18341__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__18340_SHARP_){
return cljs.core.cons.call(null,node,p1__18340_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__18343){
...
var m = map__18344__$1;
var fail = cljs.core.get.call(null,map__18344__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__18344__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__18344__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__18344__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___18346 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___18346)){
var message_18347 = temp__5720__auto___18346;
cljs.core.println.call(null,message_18347);
} else {
}
...
var temp__5720__auto___18348 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___18348)){
var message_18349 = temp__5720__auto___18348;
cljs.core.println.call(null,message_18349);
} else {
}
