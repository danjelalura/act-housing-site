...
if((i < len)){
var k = (ks[i]);
var G__10400 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__10401 = (i + (1));
m = G__10400;
i = G__10401;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10403 = c;
var G__10403__$1 = (((G__10403 == null))?null:G__10403.prototype);
if((G__10403__$1 == null)){
return null;
} else {
return G__10403__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__10405 = c;
var G__10405__$1 = (((G__10405 == null))?null:G__10405.prototype);
if((G__10405__$1 == null)){
return null;
} else {
return G__10405__$1.render;
}
})() == null)))));
});
...
while (G__10409__i < G__10409__a.length) {G__10409__a[G__10409__i] = arguments[G__10409__i + 0]; ++G__10409__i;}
  args = new cljs.core.IndexedSeq(G__10409__a,0,null);
} 
...
var G__10412 = c;
var G__10412__$1 = (((G__10412 == null))?null:G__10412.constructor);
if((G__10412__$1 == null)){
return null;
} else {
return G__10412__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__10413 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10414 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10414);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10413);
}});
...
var c = this;
var G__10418_10420 = goog.object.get(c,"cljsRatom");
if((G__10418_10420 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__10418_10420);
}
...
var renders_10421 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_10422 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_10421));
...
if((cljs.core.count.call(null,renders_10421) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_10421))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_10422)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_10422)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__10423 = o;
goog.object.set(G__10423,cljs.core.name.call(null,k),v);
