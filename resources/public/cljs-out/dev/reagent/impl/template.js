...
var G__10480 = o;
goog.object.set(G__10480,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10482__i < G__10482__a.length) {G__10482__a[G__10482__i] = arguments[G__10482__i + 0]; ++G__10482__i;}
  args = new cljs.core.IndexedSeq(G__10482__a,0,null);
} 
...
var G__10484 = o;
goog.object.set(G__10484,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__10488 = props;
var G__10488__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10488,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10488);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10488__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10488__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10489 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10489,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10489;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10490){
...
var on_write = cljs.core.get.call(null,map__10491__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__10493_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10493_SHARP_);
}));
} else {
return null;
}
...
var vec__10496 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10496,(0),null);
var id = cljs.core.nth.call(null,vec__10496,(1),null);
var className = cljs.core.nth.call(null,vec__10496,(2),null);
...
var temp__5724__auto___10500 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___10500 == null)){
} else {
var key_10501 = temp__5724__auto___10500;
(jsprops.key = key_10501);
}
...
var temp__5724__auto___10502 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___10502 == null)){
} else {
var key_10503 = temp__5724__auto___10502;
(jsprops.key = key_10503);
}
...
var temp__5724__auto___10504 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___10504 == null)){
} else {
var key_10505 = temp__5724__auto___10504;
(jsprops.key = key_10505);
}
...
var G__10507 = n;
if(cljs.core._EQ_.call(null,"",G__10507)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__10507)){
return x;
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___10511]));
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10508){
var G__10509 = cljs.core.first.call(null,seq10508);
var seq10508__$1 = cljs.core.next.call(null,seq10508);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10509,seq10508__$1);
}));
...
break;
default:
var G__10515 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10515;
continue;
...
var ctx = ({});
var vec__10517 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__10517,(0),null);
var derefed = cljs.core.nth.call(null,vec__10517,(1),null);
...
var G__10520 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10520) {
case (0):
