...
var G__15563 = devtools.prefs.pref.call(null,v);
v = G__15563;
continue;
} else {
return v;
...
}catch (e15566){var _e__14370__auto__ = e15566;
return false;
}})();
...
}catch (e15570){var _e__14370__auto__ = e15570;
return false;
}})();
...
}catch (e15572){var _e__14370__auto__ = e15572;
return false;
}}
}
});
...
var vec__15574 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15574,(0),null);
var name = cljs.core.nth.call(null,vec__15574,(1),null);
...
return cljs.core.some.call(null,(function (p1__15577_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15577_SHARP_);
}),template);
});
