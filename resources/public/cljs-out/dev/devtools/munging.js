...
var o15440 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15440["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15441 = temp__5718__auto____$1;
return (o15441["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14363__auto__ = f;
return (o__14363__auto__["toString"]).call(o__14363__auto__);
} else {
return "";
}
}catch (e15442){var _ = e15442;
return "";
}});
...
try{var o__14363__auto___15444 = t;
(o__14363__auto___15444["cljs$lang$ctorPrWriter"]).call(o__14363__auto___15444,t,writer);
}catch (e15443){var __15445 = e15443;
}
...
var char_code = (function (){var o__14363__auto__ = (new String(char$));
return (o__14363__auto__["charCodeAt"]).call(o__14363__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14363__auto__ = String;
return (o__14363__auto__["fromCharCode"]).call(o__14363__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15446 = num_code;
switch (G__15446) {
case (1):
return (185);
...
var o__14363__auto__ = String;
return (o__14363__auto__["fromCharCode"]).call(o__14363__auto__,superscript_code);
});
/**
...
}catch (e15448){var _e__14370__auto__ = e15448;
return false;
}})())){
...
var vec__15449 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15449,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o15452 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15452["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15453 = temp__5718__auto____$1;
return (o15453["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___15460 = arguments.length;
var i__4737__auto___15461 = (0);
while(true){
if((i__4737__auto___15461 < len__4736__auto___15460)){
args__4742__auto__.push((arguments[i__4737__auto___15461]));

var G__15462 = (i__4737__auto___15461 + (1));
i__4737__auto___15461 = G__15462;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15456){
var vec__15457 = p__15456;
var ns_detector = cljs.core.nth.call(null,vec__15457,(0),null);
...
var G__15463 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15464 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15463;
remaining_tokens = G__15464;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15454){
var G__15455 = cljs.core.first.call(null,seq15454);
var seq15454__$1 = cljs.core.next.call(null,seq15454);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15455,seq15454__$1);
}));
...
var vec__15468 = cljs.core.split_with.call(null,(function (p1__15467_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15467_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15468,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15468,(1),null);
...
var vec__15474 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15474,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15474,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15477 = cljs.core.rest.call(null,remaining_tokens);
var G__15478 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15477;
name_tokens = G__15478;
continue;
} else {
...
var vec__15481 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15481,(0),null);
var arity = cljs.core.nth.call(null,vec__15481,(1),null);
var vec__15484 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15484,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15484,(1),null);
var vec__15487 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15487,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15487,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15487,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15487,(3),null);
...
var vec__15493 = result;
var munged_ns = cljs.core.nth.call(null,vec__15493,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15493,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15493,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15493,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15493,(4),null);
var arity = cljs.core.nth.call(null,vec__15493,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__15497 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__15497,(0),null);
var args = cljs.core.nth.call(null,vec__15497,(1),null);
var vec__15500 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15500,(0),null);
var name = cljs.core.nth.call(null,vec__15500,(1),null);
...
var G__15503 = (arity + (1));
var G__15504 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15505){
var vec__15506 = p__15505;
var arity = cljs.core.nth.call(null,vec__15506,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15506,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__15509_SHARP_){
return cljs.core.get.call(null,arities,p1__15509_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__15510_SHARP_){
return cljs.core.drop.call(null,(2),p1__15510_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___15517 = arguments.length;
var i__4737__auto___15518 = (0);
while(true){
if((i__4737__auto___15518 < len__4736__auto___15517)){
args__4742__auto__.push((arguments[i__4737__auto___15518]));

var G__15519 = (i__4737__auto___15518 + (1));
i__4737__auto___15518 = G__15519;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15513){
var vec__15514 = p__15513;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15514,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15511){
var G__15512 = cljs.core.first.call(null,seq15511);
var seq15511__$1 = cljs.core.next.call(null,seq15511);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15512,seq15511__$1);
}));
...
var map__15522 = options;
var map__15522__$1 = (((((!((map__15522 == null))))?(((((map__15522.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15522.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15522):map__15522);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15522__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15522__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15522__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15522__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15523 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15523,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15523,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15523,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15523,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15523,(4),null);
var arity = cljs.core.nth.call(null,vec__15523,(5),null);
...
var o__14363__auto__ = f;
return (o__14363__auto__["getBasis"]).call(o__14363__auto__);
});
/**
...
}catch (e15527){var _e__14370__auto__ = e15527;
...
var G__15528 = (obj[cljs.core.first.call(null,path)]);
var G__15529 = cljs.core.rest.call(null,path);
obj = G__15528;
path = G__15529;
continue;
} else {
...
var _STAR_ = (function (accum,p__15530){
var vec__15531 = p__15530;
var bit = cljs.core.nth.call(null,vec__15531,(0),null);
var protocol = cljs.core.nth.call(null,vec__15531,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15534){
var vec__15535 = p__15534;
var ns = cljs.core.nth.call(null,vec__15535,(0),null);
var name = cljs.core.nth.call(null,vec__15535,(1),null);
var selector = cljs.core.nth.call(null,vec__15535,(2),null);
...
var post_process = (function (p__15539){
var vec__15540 = p__15539;
var munged_name = cljs.core.nth.call(null,vec__15540,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15540,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__15538_SHARP_){
return (obj[cljs.core.first.call(null,p1__15538_SHARP_)]);
}),sorted_matches);
